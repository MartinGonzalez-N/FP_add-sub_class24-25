# SimVision Command Script (Mon Mar 03 22:28:10 UTC 2025)
#
# Version 23.09.s001
#
...
# Waveform windows
#
if {[catch {window new WaveWindow -name "Waveform 1" -geometry 1366x705+0+23}] != ""} {
    window geometry "Waveform 1" 1366x705+0+23
}
...
set id [waveform add -signals [subst  {
	{$dbNames(realName1)::[format {tb_top.add_sub_main_inst.mantissa_a[22:0]}]}
	} ]]
waveform hierarchy collapse $id
set id [waveform add -signals [subst  {
	{$dbNames(realName1)::[format {tb_top.add_sub_main_inst.mantissa_b[22:0]}]}
	} ]]
set id [waveform add -signals [subst  {
	{$dbNames(realName1)::[format {tb_top.add_sub_main_inst.mantissa_a_shifted[26:0]}]}
	} ]]
waveform hierarchy collapse $id
set id [waveform add -signals [subst  {
	{$dbNames(realName1)::[format {tb_top.add_sub_main_inst.shift_spaces[4:0]}]}
	} ]]
waveform hierarchy collapse $id
...
#
if {[catch {window new SrcBrowser -name "Source Browser 1" -geometry 1366x705+0+23}] != ""} {
    window geometry "Source Browser 1" 1366x705+0+23
}
...
srcbrowser show -scope tb_top.add_sub_main_inst -file /home/joc/dd_C1_25/FP_add-sub_class24-25/rtl/add_sub_main.sv -line 34
